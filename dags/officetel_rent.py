...
def transform_officetel_rent_data(city, data):
    ...
    for item in root.findall('.//item'):
        ...
        res.append((trade_ymd, city, ku, dong, jicode, name, floor, area, built_year, deposite, monthly_pay))
...
for address, code in dong_code.items():
    with DAG(
        ...
        load_officetel_rent_data(schema, table, transform_officetel_rent_data(city, extract_officetel_rent_data(url, key, code)))
